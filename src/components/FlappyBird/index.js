...
const FlappyBird = () => {
    ...
    }, [currentGameStatus, GameStatus.PLAYING, getRandomLetter])
    ...
    }, [currentGameStatus, letter, jump, newGame, GameStatus.GAME_OVER, GameStatus.NOT_STARTED, GameStatus.PLAYING])
    ...
    }, [currentGameStatus, countdown, GameStatus.PLAYING, changeGameStatus, GameStatus.COUNTDOWN])
    ...
    }, [currentGameStatus, birdPosition, birdVelocity, score, addPipe, calculatePipeSpeed, handleGameOver, GameStatus.PLAYING])
